...
export const userApi = {
  ...
  submitAddress: (data: { userId: string; street: string, city: string, state: string, postalCode: string, country: string }) =>
    client.post("/api/user/submit_address", data),

  submitNok: (data: { userId: string; fullName: string, relationship: string, phone: string, email: string, address: string }) =>
