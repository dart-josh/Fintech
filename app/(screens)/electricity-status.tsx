...
export default function ElectricityStatusPage() {
  ...
  const handleShareReceipt = () => {
    router.push({
      pathname: "/receipt",
      params: {
        id: `electricity-${receipt.date}`,
        type: "Electricity Top up",
  ...
  const statusConfig = {
    success: {
      ...
      subtitle: "Your Electricity top up was successful",
      color: "#16A34A",
    },
    failed: {
      icon: "x-circle",
    ...
    pending: {
      ...
      subtitle: "Your Electricity top up is being processed",
      color: "#F59E0B",
    },
  };
    ...
    <SafeAreaProvider>
      ...
      >
        ...
        <View style={[styles.detailsCard, { backgroundColor: colors.card }]}>
          ...
          {detail("Meter Number", receipt.meterNumber, colors)}
