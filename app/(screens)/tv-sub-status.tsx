...
export default function TvSubscriptionStatusPage() {
  ...
  const handleShareReceipt = () => {
    router.push({
      ...
      params: {
        ...
        description: `${receipt.provider} subscription for ${receipt.customerName}`,
        date: receipt.date,
      },
    });
  };
  ...
  const statusConfig = {
    success: {
      ...
      subtitle: "Your TV subscription was successful",
      color: "#16A34A",
    },
    failed: {
      icon: "x-circle",
      title: "Subscription Failed",
      subtitle: "Something went wrong with this subscription",
      color: "#DC2626",
    },
    pending: {
      icon: "clock",
      title: "Subscription Pending",
      subtitle: "Your TV subscription is being processed",
      color: "#F59E0B",
    },
  };
      ...
      >
        ...
        <View style={[styles.statusCard, { backgroundColor: colors.card }]}>
          ...
          <Text style={{ color: colors.textSecondary, textAlign: "center" }}>
            {receipt.provider} • {receipt.package}
          </Text>
        </View>
        ...
        <View style={[styles.detailsCard, { backgroundColor: colors.card }]}>
          ...
          {detail("Smartcard Number", receipt.smartcard, colors)}
          {detail("Customer Name", receipt.customerName, colors)}
          {detail("Package", receipt.package, colors)}
          {detail(
            "Amount",
            `₦${Number(receipt.amount).toLocaleString()}`,
            colors,
