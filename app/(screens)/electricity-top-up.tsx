...
import { ELECTRICITY_PROVIDERS } from "@/utils/globalVariables";
import { useWalletStore } from "@/store/wallet.store";
import { useConfirmPinHook } from "@/hooks/pinVerification.hook";
import { KeyboardAwareScrollView } from "react-native-keyboard-aware-scroll-view";
import { purchaseElectricity } from "@/services/wallet.service";
import { useUserStore } from "@/store/user.store";
import ElectricityConfirmationModal from "@/components/modals/ElectricityConfirmationModal";

export default function ElectricityTopUp() {
  ...
  /* Simulated Fetch */
  const fetchMeterNumberName = async (value: string) => {
  ...
  const handlePay = () => {
    ...
    confirmPin(async () => {
      ...
      router.push({
        pathname: "/electricity-status",
        params: { ...res, meterNumber: res.number, customerName: res.customer },
      });
    });
  };
    ...
    >
      ...
      >
        ...
        <Text style={[styles.subtitle, { color: colors.textMuted }]}>
          Purchase electricity with ease
        </Text>
        ...
        <View style={styles.fieldContainer}>
          ...
          >
            ...
            >
              {provider?.name || "Select Service Provider"}
            </Text>
          ...
          <View style={styles.fieldContainer}>
            ...
            >
              ...
              >
                <Text
                  style={{
                    color: meterType === "prepaid" ? "#fff" : colors.text,
                    fontWeight: "600",
                    fontSize: 15,
                  }}
                >
              ...
              >
                <Text
                  style={{
                    color: meterType === "postpaid" ? "#fff" : colors.text,
                    fontWeight: "600",
                    fontSize: 15,
                  }}
                >
        ...
        {provider && (
          <View style={styles.fieldContainer}>
            ...
            <TextInput
              ...
              onChangeText={fetchMeterNumberName}
              style={[
                styles.input,
                {
                  borderColor:
